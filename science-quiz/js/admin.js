...
function controlScores() {
    ...
    <div class='eachUser'>
        ...
        <button id=' |name of hte user| ' class="col-xs-12 col-sm-12 col-md-4 col-lg-4 btn btn-success' Update Score </button>
    </div>
    ...
    */
    for (var i = 0; i < users_number; i++) {
        $("#score-controls").append("<div class='eachUser col-xs-12 col-sm-12 col-md-12 col-lg-12'>" +
            ...
            "<button id = '" + users_names[i] + "' class = 'col-xs-12 col-sm-12 col-md-4 col-lg-4 btn btn-success " +
